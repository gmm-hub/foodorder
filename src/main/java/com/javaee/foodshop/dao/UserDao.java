...
public class UserDao extends BaseDao<User> {
    ...
    public int insert(User user) throws SQLException {
        ...
        int i = this.update(sql,user.getId(),user.getUsername(),user.getPassword(),user.getSex(),user.getRealname(),user.getTel(),user.getAddress(),
        user.getEmail(),user.getState(),user.getCode(),user.getBirthday());
        return i;
    }
